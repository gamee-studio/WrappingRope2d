...
namespace WrappingRopeLibrary.Editors
{
    ...
    public class RopeEditor : Editor
    {
        ...
        private bool _isProfileExpanded = false;
        ...
        protected virtual void ShowProfilePreview(SerializedProperty profile)
        {
            if (!profile.isArray)
                return;
            _isProfileExpanded =  EditorGUILayout.Foldout(_isProfileExpanded, "Profile");
        ...
        protected virtual void DrawPreview(List<Vector2> polygon)
        {
            ...
            EditorGUI.DrawPreviewTexture(new Rect(layoutRect.position, new Vector2(layoutRect.width, 100)), _texture, null, ScaleMode.ScaleAndCrop);
        }
