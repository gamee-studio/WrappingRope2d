...
// The source code was taken from https://myunitynotes.wordpress.com/2014/08/18/2d-simple-polygon-drawing-in-unity/
namespace WrappingRopeLibrary.Utils
{
    public class Triangulator
    {
        ...
        private List<Vector2> _rawPoints;
        private List<Vector3> m_TriPointList;
        private int Pointcount;
        private PolyPoint[] PolyPointList;

        public List<Vector3> GetTriangulationIndexes(List<Vector2> rawPoints)
        {
        ...
        private bool isCleanEar(int Ear)
        {
            ...
            Vector2 v0 = _rawPoints[PolyPointList[Ear].PrevP - 1] - _rawPoints[Ear - 1];
            Vector2 v1 = _rawPoints[PolyPointList[Ear].NextP - 1] - _rawPoints[Ear - 1];
            Vector2 v2;
            ...
            while (i != -1)
            {
                ...
                v2 = _rawPoints[i - 1] - _rawPoints[Ear - 1];
        ...
        private bool isReflective(int P)
        {
            ...
            Vector2 v0 = _rawPoints[PolyPointList[P].PrevP - 1] - _rawPoints[P - 1];
            Vector2 v1 = _rawPoints[PolyPointList[P].NextP - 1] - _rawPoints[P - 1];
